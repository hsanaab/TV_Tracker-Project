...
<body>
    ...
    <div class="navigation">
        <a href="add_show.php" class="btn">➕ Add a New Show</a><br><br>
        <a href="browse_reviews.php" class="btn">🔎 Browse Reviews</a><br><br>
        <a href="watchlist.php" class="btn">📋 View Watchlist</a><br><br>
